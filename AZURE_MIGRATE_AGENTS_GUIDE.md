...
> | `status` | Text | `"Processing"`, `"Complete"`, or `"Error"` | `"Error"` | `coalesce(variables('statusVar'), 'Error')` |
> | `message` | Text | Human-readable status description | `"No details available."` | `coalesce(variables('messageVar'), 'No details available.')` |
